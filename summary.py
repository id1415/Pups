...
async def process_pupps_summary(chat_id: int, log_data: list, thread_id: int = None):
    ...
    summary_system_prompt = (
        ...
        "Игнорируй обычное ограничение на краткость! Сделай развёрнутый, резкий, дерзкий и угарный пересказ того, о чем эти персонажи тут обсуждали. "
        "Стебись, выделяй главных героев. Пиши в стиле Пупса. Размер: около 2000–3000 символов (но СТРОГО не больше 3500 символов). "
        f"Вот их писанина:\n\n{full_history_text}"
    )
